...
(0.5, 1, 1.5)
```
Check out the [Vector3.h](includes/structs/Vector3.h) file to see how a specialised vector struct is made using the base class, and feel free to use the specialised vector structs I have already made.
